...
## 3. Syncing documentation from GitHub

If your documentation already lives on GitHub and you'd prefer not to use the site's built-in editor,
you can sync your mod wiki directly from a repository.

Go to your mod settings and scroll down to **GitHub Repository URL**.
Paste your repository link there — the site will automatically keep your documentation in sync with the repo,
and manual editing will be disabled.

Below that, you'll find **Repository Path**, which specifies which folder in your repository contains the documentation.
If your entire repository is documentation, leave this field empty.